...
def boar_brawl(player_score, opponent_score):
    ...
    hundreds, ones = opponent_score // 100, opponent_score % 10
    tens_digit = (opponent_score - 100 * hundreds - ones) // 10
    if not (tens_digit - ones_digit):
        return 1
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    updated_score = simple_update(num_rolls, player_score, opponent_score, dice)
    return sus_points(updated_score)
    # END PROBLEM 4
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    threshold = make_averaged(always_roll(6))(score, opponent_score)
