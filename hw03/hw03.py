...
def interleaved_sum(n, odd_term, even_term):
    ...
    True
    """
    def helper(k, term1, term2):
        if k == n:
            return term1(k)
        else:
            return term1(k) + helper(k+1, term2, term1)
...
def count_coins(total):
    ...
    True
    """
    def coin_counter(total, largest):
        if total == 0:
            return 1
        elif total < 0:
            return 0
            ...
            with_coin = coin_counter(total - largest, largest)
            without_coin = coin_counter(total, next_smaller_coin(largest))
